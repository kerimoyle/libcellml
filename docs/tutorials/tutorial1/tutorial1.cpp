 ...
 *    - read the contents of a CellML file using the Parser
 *    - deserialse the contents into a Model structure
...
int main() {
  ...
  //        their name and id to the screen
  ...
  //  2.c   Investigate the variables inside the component, and print their
  //        names to terminal
  ...
  //  2.d   Investigate the maths which connects the variables in this
